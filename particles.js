	...
	var pJS=function(e,a){
		...
		i.fn.retinaInit=function(){
			i.retina_detect&&window.devicePixelRatio>1?
				(i.canvas.pxratio=window.devicePixelRatio,i.tmp.retina=!0):(i.canvas.pxratio=1,i.tmp.retina=!1),
		...
		i.fn.canvasInit=function(){
			...
			i.fn.canvasSize=function(){
				...
				i&&i.interactivity.events.resize&&window.addEventListener
					("resize",function(){
				...
				i.fn.canvasClear=function(){
					...
					i.fn.particle=function(e,a,t){
						...
						if(e.value instanceof Array){
							...
							this.color.rgb=hexToRgb(s)}else void 0!=e.value.r&&void 0!=e.value.g&&void 0!=e.value.b&&
